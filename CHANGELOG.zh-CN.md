...
<<<<<<< HEAD
||||||| parent of 84b0922 (fix(console): name audit outcomes and complete the operation map)
...
>>>>>>> 84b0922 (fix(console): name audit outcomes and complete the operation map)
## 0.4.0 - 2026-09-26
