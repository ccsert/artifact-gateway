...
The [0.4.0 Release](https://github.com/ccsert/artifact-gateway/releases/tag/v0.4.0)
...
```text
ghcr.io/ccsert/artifact-gateway:0.4.0
ghcr.io/ccsert/artifact-gateway-console:0.4.0
...
should pin `0.4.0` or the reported image digest. Package visibility follows
