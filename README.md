...
<p align="center">
  ...
  <a href="https://github.com/ccsert/artifact-gateway/releases/tag/v0.3.1"><img alt="Release 0.3.1" src="https://img.shields.io/badge/release-0.3.1-2563EB"></a>
...
The [0.3.1 Release](https://github.com/ccsert/artifact-gateway/releases/tag/v0.3.1)
...
```text
ghcr.io/ccsert/artifact-gateway:0.3.1
ghcr.io/ccsert/artifact-gateway-console:0.3.1
...
should pin `0.3.1` or the reported image digest. Package visibility follows
