-- +goose Up
CREATE TABLE IF NOT EXISTS native_raw_uploads (
    id UUID PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS native_raw_uploads_open_idx ON native_raw_uploads (repository_id, expires_at) WHERE state='open';
